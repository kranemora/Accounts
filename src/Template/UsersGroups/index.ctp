 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $usersGroups
 */
?>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $usersGroup->user_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $usersGroup->user_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $usersGroup->user_id], ['confirm' => __('Are you sure you want to delete # {0}?', $usersGroup->user_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
